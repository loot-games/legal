...
Information collected or stored is used for the following purposes:

- Saving game state, scores, and settings so you can continue playing
- Displaying and optimizing advertisements
- Checking remove-ads purchase status and controlling ad display
...
You can control settings and tracking through the following methods:
...
The Service does not knowingly collect personal information from children under 13.

## 6. International Data Transfers

Data collected by third-party services such as Google and Apple may be transferred to servers in various countries, including the United States.
